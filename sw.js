/* Service Worker — Silvi-Aura (Alimentación y estimulación temprana)
   ...
   acá (por ejemplo CACHE_NAME "silvi-aura-v2") para que los celulares bajen
   la versión nueva en vez de servir la vieja desde caché. */

const CACHE_NAME = "silvi-aura-v1";
const APP_SHELL = [
  "./",
  "./index.html",
  "./manifest.json",
